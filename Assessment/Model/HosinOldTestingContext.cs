...
public partial class HosinOldTestingContext : DbContext
{
    ...
    public virtual DbSet<ManagementsInsideInAndOutUserPer> ManagementsInsideInAndOutUserPer { get; set; }
    public virtual DbSet<Account_waiting_payment> Account_waiting_payment { get; set; }
    public virtual DbSet<statesrate> statesrate { get; set; }
    public virtual DbSet<City> Cities { get; set; }
    public virtual DbSet<Directorate> Directorates { get; set; }
    public virtual DbSet<District> Districts { get; set; }
    public virtual DbSet<Intallments> Intallments { get; set; }
    ...
    public virtual DbSet<UseresWaiting> UseresWaiting { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=185.140.192.85\r\n;Database=Hosin_Old_Testing;User Id=team1;Password=Teamwork123456@;TrustServerCertificate=true;MultipleActiveResultSets=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        //Hosin_Old_Testing
        //new_testing_db
        //        modelBuilder.Entity<UseresUserUserPermission>().HasData(
        //                new UseresUserUserPermission()
        //                {
        //                    Id = 1,
        //                    UserId = 1,
        ...
        modelBuilder.Entity<AccountingStudentPayment>()
    .HasIndex(e => new { e.Date, e.VoucherNumber })
    .IsUnique();
